...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_html(
        ...
        "<code>/top</code> - TOP 10 oyinchilar\n"
...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_html(
        "Yordam\n\n"
        "<b>Online</b> yoki <b>/status</b> - server holati\n"
        "<b>/top</b> - arenacs.uz dan TOP 10 rasm\n\n"
        "Har safar <b>Online</b> yozilganda oldingi xabar o'chib, yangi chiqadi."
    )

async def send_status_message(update: Update, context: ContextTypes.DEFAULT_TYPE, reply_to_message_id=None):
...
async def on_online_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await send_status_message(update, context, reply_to_message_id=update.message.message_id)

async def cmd_top(update: Update, context: ContextTypes.DEFAULT_TYPE):
    msg = await update.message.reply_html("TOP 10 yuklanmoqda...")
    loop = asyncio.get_event_loop()
